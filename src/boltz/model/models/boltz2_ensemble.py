...
class Boltz2Ensemble(LightningModule):
    """Boltz2 model with ensemble-based protein-protein affinity prediction."""
    ...
    def __init__(
        ...
        ensemble_sampling_strategy: str = "top_k",  # "random", "top_k", "adaptive"
        ...
        if affinity_prediction:
            ...
            ensemble_args = {
                ...
                "ensemble_sampling_strategy": ensemble_sampling_strategy,
                ...
                if self.affinity_ensemble:
                    ...
                    if self.affinity_mw_correction:
                        ...
                        result["affinity_pred_value"] = (
                            model_coef * result["affinity_pred_value"]
                            + mw_coef * mw
                            + bias
                        )
